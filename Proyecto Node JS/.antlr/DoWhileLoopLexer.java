...
public class DoWhileLoopLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CERO", "UNO", "BREAK", "PUTS", "DO", "WHILE", "CUOTE", "SEMI", "LKEY", 
			"RKEY", "LETRA", "DIGITO", "LPAREN", "RPAREN", "CADENA", "CARACTERES", 
	...
	public DoWhileLoopLexer(CharStream input) {
		super(input);
